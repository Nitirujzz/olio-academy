...
const MODULES = [
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    quiz: [
      { type: "mc", q: "EVOO มีประวัติยาวนานกี่ปี?", options: ["1,000 ปี", "3,000 ปี", "6,000 ปี", "10,000 ปี"], correct: 2, explain: "ประวัติ EVOO เก่าแก่กว่าอารยธรรมกรีก-โรมัน — ลองนึกถึงหลักฐานทางโบราณคดีในพื้นที่ Mediterranean" },
      { type: "mc", q: "ประเทศใดเป็นผู้ผลิต EVOO อันดับ 1 ของโลก?", options: ["Italy", "Spain", "Greece", "Tunisia"], correct: 1, explain: "ผู้ผลิตอันดับ 1 ≠ คุณภาพสูงสุด — นึกถึงประเทศที่มีพื้นที่ปลูกมะกอกและ market share มากที่สุดในโลก" },
      { type: "mc", q: "Acidity สูงสุดที่ EVOO มีได้คือเท่าไหร่?", options: ["0.5%", "0.8%", "1.5%", "3.3%"], correct: 1, explain: "EVOO เป็นเกรดสูงสุด มาตรฐาน acidity จึงเข้มงวดมาก — ดูจาก IOC standard ใน lesson" },
      { type: "mc", q: "เกรดใดที่ Hibi ไม่ควรใช้?", options: ["Extra Virgin", "Virgin", "Olive Oil (blend)", "Pomace Oil"], correct: 3, explain: "นึกถึงเกรดที่ผ่านกระบวนการ refine ทางเคมีหรือสกัดด้วย solvent — คุณภาพและ polyphenols ต่ำที่สุด" },
      { type: "tf", q: "Pure Olive Oil คือ EVOO เกรดสูงสุด", correct: false, explain: "Pure Olive Oil มีคำว่า 'Olive' อยู่ แต่ไม่ได้หมายความว่าเป็นเกรดเดียวกับ EVOO — ลองนึกถึงความหมายของ 'Pure' ในภาษาอุตสาหกรรม" },
      { type: "tf", q: "EVOO มี Oleocanthal ที่ไม่มีในน้ำมันชนิดอื่น", correct: true, explain: "Oleocanthal เป็น compound เฉพาะ — ลองนึกว่าน้ำมันพืชชนิดอื่นมีสารนี้ด้วยหรือไม่" },
      { type: "mc", q: "ทำไม EVOO ในขวดใสด้อยกว่าขวดสีเข้ม?", options: ["ราคาถูกกว่า", "แสงทำลาย polyphenols", "Plastic ละลาย", "ดูไม่สวย"], correct: 1, explain: "EVOO มีศัตรู 4 ตัว — ขวดใสป้องกันศัตรูตัวไหนได้บ้าง? ลองนึกถึงสิ่งที่ผ่านแก้วใสได้" },
      { type: "mc", q: "ขั้นตอนใดทำให้น้ำมันมะกอกได้เกรด EVOO ได้?", options: ["Heat extraction", "Chemical refining", "Cold pressing", "Solvent extraction"], correct: 2, explain: "EVOO = Extra Virgin ต้องไม่ผ่านความร้อนหรือสารเคมี — วิธีการสกัดแบบใดที่ preserve polyphenols ได้ดีที่สุด?" },
    ],
  },
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    quiz: [
      { type: "mc", q: "Oleic Acid ใน EVOO ดีคือควรมีกี่ %?", options: ["20-40%", "55-83%", "90-95%", "5-10%"], correct: 1, explain: "Oleic acid คือ MUFA หลักใน EVOO ซึ่งมีสัดส่วนสูงกว่าครึ่ง — ดูจาก fatty acid profile ใน lesson" },
      { type: "mc", q: "Polyphenol ตัวใดที่ทำให้คอเผ็ดและมีฤทธิ์ anti-inflammatory?", options: ["Hydroxytyrosol", "Tyrosol", "Oleocanthal", "Oleuropein"], correct: 2, explain: "สารนี้ทำให้รู้สึกเผ็ดร้อนในคอและมีชื่อคล้ายยาแก้ปวด ibuprofen — ดูจาก polyphenol list ใน lesson" },
      { type: "mc", q: "Antioxidant ที่แรงที่สุดในธรรมชาติคือ?", options: ["Vitamin C", "Vitamin E", "Hydroxytyrosol", "Lycopene"], correct: 2, explain: "ไม่ใช่วิตามิน แต่เป็น polyphenol จาก EVOO — ชื่อเริ่มต้นด้วย H" },
      { type: "tf", q: "EVOO มี Polyphenols 5-10 ชนิดเท่านั้น", correct: false, explain: "EVOO มี polyphenols หลายสิบชนิด ไม่ใช่แค่ไม่กี่ตัว — ลองนึกถึงตัวเลขที่ mention ใน lesson" },
      { type: "mc", q: "3-cough Test บ่งบอกอะไร?", options: ["EVOO มี acidity สูง", "Oleocanthal สูง (polyphenols ดี)", "EVOO เก่า", "EVOO แพง"], correct: 1, explain: "ทำไมถึงไอ? ลองนึกว่าสารอะไรใน EVOO ที่ระคายเคืองในลำคอส่วนล่าง และนั่นเป็นสัญลักษณ์ที่ดีหรือไม่ดี" },
      { type: "mc", q: "MUFA ในที่นี้ย่อมาจาก?", options: ["Multi-Unsaturated Fatty Acids", "Monounsaturated Fatty Acids", "Modified Unrefined Fats", "Mediterranean Unsaturated Fats"], correct: 1, explain: "M = Mono, U = Unsaturated, FA = Fatty Acids — ลอง expand ตัวย่อแต่ละตัวดู" },
      { type: "tf", q: "EVOO ที่ดีต้องไม่ขมและไม่เผ็ดในคอ", correct: false, explain: "ลองนึกถึง 3 positive attributes ของ EVOO — ขมและเผ็ดอยู่ในรายการนั้นไหม?" },
      { type: "mc", q: "ความเข้มข้น polyphenols ขั้นต่ำที่ EU อนุญาตให้ claim ได้?", options: ["100 mg/kg", "250 mg/kg", "500 mg/kg", "1000 mg/kg"], correct: 1, explain: "ดูจาก EU Regulation 432/2012 ใน lesson — ตัวเลขอยู่ในส่วน approved health claims conditions" },
      { type: "mc", q: "Squalene ดีต่ออะไรเป็นพิเศษ?", options: ["ตา", "หัวใจ", "ผิว", "สมอง"], correct: 2, explain: "Squalene พบเยอะในชั้น lipid ของ organ หนึ่งที่เราสัมผัสทุกวัน — ลองนึกถึง organ นั้น" },
      { type: "tf", q: "Oleocanthal ทำงานคล้าย ibuprofen แต่ไม่มี side effects ต่อกระเพาะ", correct: true, explain: "Oleocanthal ยับยั้ง enzyme เดียวกับยาแก้ปวดบางชนิด — แต่ mechanism และ dose เหมือนกัน 100% ไหม?" },
    ],
  },
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    quiz: [
      { type: "mc", q: "PREDIMED Study พบว่า EVOO ช่วยลดเสี่ยง heart disease กี่ %?", options: ["10%", "20%", "30%", "50%"], correct: 2, explain: "PREDIMED เป็น landmark study ของ Mediterranean Diet — ตัวเลขลดความเสี่ยงนี้มีนัยสำคัญ ดูใน synergy lesson" },
      { type: "mc", q: "EVOO + มัทฉะดูดซึมสารต้านอนุมูลอิสระเพิ่มกี่เท่า?", options: ["1.2 เท่า", "2-7 เท่า", "10 เท่า", "50 เท่า"], correct: 1, explain: "ไขมันช่วยดูดซึม fat-soluble compounds ในมัทฉะ — ตัวเลขนี้อยู่ใน synergy section" },
      { type: "mc", q: "ตามกฎหมายไทย คำใดพูดได้?", options: ['"รักษาโรคหัวใจ"', '"ลด cholesterol"', '"ส่วนหนึ่งของ heart-healthy diet"', '"ป้องกันมะเร็ง"'], correct: 2, explain: "พ.ร.บ. อาหารไทยห้าม claim รักษาโรค — แต่อนุญาตให้พูดถึงบริบทโภชนาการได้ ลองดูตัวอย่างที่พูดได้ใน lesson" },
      { type: "tf", q: "EGCG ในมัทฉะดูดซึมดีขึ้นเมื่อกินกับไขมัน", correct: true, explain: "EGCG คือ catechin — ลองนึกว่า compound นี้ละลายในน้ำหรือในไขมัน และนั่นมีผลต่อการดูดซึมอย่างไร" },
      { type: "mc", q: "Silent inflammation เกี่ยวข้องกับโรคใด?", options: ["NCDs (Heart, Diabetes, Cancer)", "ติดเชื้อ", "กระดูกหัก", "ไข้หวัด"], correct: 0, explain: "Silent = ไม่แสดงอาการชัดเจน แต่สะสม — โรคเรื้อรังที่คร่าชีวิตคนมากที่สุดในปัจจุบัน" },
      { type: "mc", q: "ทำไม EVOO ทำให้คาเฟอีนปล่อยช้า?", options: ["เพราะลด pH", "ไขมันเป็น matrix slow release", "ทำลายคาเฟอีน", "เพิ่ม water absorption"], correct: 1, explain: "EVOO เป็นไขมัน — ลองนึกว่าไขมันมีผลต่อ absorption rate ของ compound ในกระเพาะอย่างไร" },
      { type: "tf", q: "Hydroxytyrosol สามารถข้าม blood-brain barrier ได้", correct: true, explain: "Blood-brain barrier ยอมให้ molecule บางชนิดผ่านได้ — ลองนึกว่า Hydroxytyrosol มีขนาดโมเลกุลเป็นอย่างไร" },
      { type: "mc", q: "EVOO ปริมาณเท่าไหร่ต่อวันที่ Mediterranean Diet แนะนำ?", options: ["10ml", "25ml", "50ml", "100ml"], correct: 2, explain: "Mediterranean Diet แนะนำประมาณ 2-3 ช้อนโต๊ะ — แต่ละช้อนโต๊ะ ≈ 13-15ml ลองคำนวณดู" },
    ],
  },
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    quiz: [
      { type: "mc", q: "พันธุ์มะกอกอิตาเลียนของ Liguria คือ?", options: ["Frantoio", "Taggiasca", "Picual", "Koroneiki"], correct: 1, explain: "Liguria = Italian Riviera ทางตะวันตกเฉียงเหนือ — พันธุ์ที่ขึ้นชื่อที่นั่นมีชื่อขึ้นต้นด้วย T" },
      { type: "mc", q: "พันธุ์ใดเข้ากับมัทฉะดีที่สุด (นุ่ม หวาน)?", options: ["Picual", "Coratina", "Arbequina", "Koroneiki"], correct: 2, explain: "มัทฉะขมอยู่แล้ว ควร pair กับ oil profile อ่อนโยน ไม่ขมซ้อน — ดูพันธุ์ 'delicate' ใน lesson" },
      { type: "mc", q: "พันธุ์ที่ polyphenols สูงสุด สาย performance?", options: ["Arbequina", "Empeltre", "Picual / Coratina / Koroneiki", "Taggiasca"], correct: 2, explain: "ไม่ใช่พันธุ์เดียว แต่เป็นกลุ่ม 'robust' จาก Italy, Spain, และ Greece ที่เด่นเรื่อง polyphenols สูง" },
      { type: "tf", q: "Italy มีพันธุ์มะกอกมากกว่า 100 ชนิด", correct: true, explain: "Italy มีความหลากหลายทาง cultivar สูงมาก — ลองนึกว่าตัวเลข 100 ชนิดนั้นน้อยหรือมากเมื่อเทียบกับที่ lesson กล่าวไว้" },
      { type: "mc", q: "Spain ผลิต EVOO กี่% ของโลก?", options: ["20%", "30%", "50%", "75%"], correct: 2, explain: "Spain เป็น producer อันดับ 1 ของโลก — market share ของเขาใหญ่กว่า Italy มาก ดูจาก lesson" },
      { type: "mc", q: "Kalamata เป็นพันธุ์ที่ใช้ทำอะไร?", options: ["น้ำมัน EVOO", "มะกอกตาราง", "Olive butter", "Pomace"], correct: 1, explain: "Kalamata เป็นมะกอกสีม่วงเข้มจาก Greece — ลองนึกว่าคุณเคยเห็น Kalamata ในอาหารอะไรบ้าง" },
      { type: "mc", q: "พันธุ์ Tuscan ที่มักผสมกับ Frantoio?", options: ["Picual", "Leccino", "Taggiasca", "Koroneiki"], correct: 1, explain: "Frantoio ขมและเผ็ดแรง ต้องผสมกับพันธุ์ที่ mild กว่า — ดูพันธุ์ Tuscan ตัวอื่นใน cultivar lesson" },
      { type: "tf", q: "Coratina จาก Puglia มี profile นุ่มและหวาน", correct: false, explain: "ลองนึกถึง profile ของ Coratina — มันอยู่ในกลุ่ม 'delicate' หรือ 'robust'? ดู cultivar comparison ใน lesson" },
    ],
  },
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    quiz: [
      { type: "mc", q: "อุณหภูมิสูงสุดสำหรับ cold extraction?", options: ["20°C", "25°C", "27°C", "35°C"], correct: 2, explain: "'Cold' extraction มีตัวเลข standard กำหนดโดย IOC — ไม่ใช่แค่ 'ต่ำๆ' แต่มีตัวเลขชัดเจน" },
      { type: "mc", q: "ช่วงไหนคือ early harvest ของ Mediterranean?", options: ["ก.ค.-ส.ค.", "ต.ค.-พ.ย.", "ม.ค.-ก.พ.", "เม.ย.-พ.ค."], correct: 1, explain: "Early harvest = ผลเขียว polyphenols สูง — Mediterranean harvest season เริ่มปลายปี ดู timeline ใน lesson" },
      { type: "tf", q: "Early harvest มี polyphenols สูงกว่า late harvest", correct: true, explain: "นึกถึงความสัมพันธ์ระหว่างความสุกของผลกับ polyphenols — ผลเขียวกับผลสุกดำต่างกันอย่างไร?" },
      { type: "mc", q: "Centrifuge แบบใดเก็บ polyphenols ได้ดีกว่า?", options: ["3-phase", "2-phase", "Press", "ไม่ต่าง"], correct: 1, explain: "2-phase vs 3-phase — ความแตกต่างหลักคือปริมาณน้ำที่ใช้ ซึ่งมีผลต่อ polyphenols ที่ถูกล้างออก" },
      { type: "mc", q: "4 ศัตรูของ EVOO คือ?", options: ["น้ำ ดิน เกลือ น้ำตาล", "แสง ความร้อน อ็อกซิเจน เวลา", "ฝุ่น น้ำตาล กรด ด่าง", "ไม่มี"], correct: 1, explain: "นึกถึงสิ่งที่ทำให้ oil เสื่อมคุณภาพ — ทั้ง 4 ตัวอยู่รอบๆ เราในชีวิตประจำวัน" },
      { type: "tf", q: "Unfiltered EVOO เก็บได้นานกว่า filtered", correct: false, explain: "Unfiltered EVOO มีอะไรเหลืออยู่ในขวด? ลองนึกว่าสิ่งนั้นมีผลต่อ shelf life อย่างไร" },
      { type: "mc", q: "EVOO หลังเปิดขวดควรใช้ภายในกี่วัน?", options: ["7 วัน", "30 วัน", "60 วัน", "180 วัน"], correct: 2, explain: "หลังเปิดขวด oxygen เข้า oxidation เริ่ม — เวลาที่แนะนำไม่สั้นเกิน 1 เดือน แต่ก็ไม่ยาวเกิน 6 เดือน" },
      { type: "mc", q: "ทำไม EVOO ไม่ควรอยู่ใกล้เตา?", options: ["ดูไม่สวย", "ความร้อน + แสงทำลาย", "กลิ่นปนเปื้อน", "ทุกข้อ"], correct: 3, explain: "ใกล้เตา = รวม 'ศัตรู' หลายตัวไว้ด้วยกัน — ลองนับว่ามีกี่ตัวจาก 4 ศัตรูที่อยู่บริเวณนั้น" },
    ],
  },
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    quiz: [
      { type: "mc", q: "3 attributes บวกของ EVOO คือ?", options: ["Sweet, Sour, Salty", "Light, Medium, Heavy", "Fruity, Bitter, Pungent", "Soft, Bold, Crisp"], correct: 2, explain: "positive attributes ทั้ง 3 เกี่ยวกับกลิ่น ความขม และความเผ็ด — ทุกตัวถือเป็น ข้อดีทั้งสิ้น" },
      { type: "mc", q: "ความเผ็ดร้อนในคอบ่งบอกอะไร?", options: ["EVOO เสีย", "Polyphenols / Oleocanthal สูง", "Acidity เกิน", "ผลสุกเกิน"], correct: 1, explain: "ความเผ็ดในคอมาจาก attribute 'Pungent' — บ่งบอกถึงสารสำคัญใน EVOO ที่มีฤทธิ์อะไร?" },
      { type: "mc", q: "อุณหภูมิที่ขอ EVOO ตอนชิม?", options: ["10°C", "20°C", "28°C", "40°C"], correct: 2, explain: "อุณหภูมิชิมต้องพอดี — ไม่เย็นจนดมกลิ่นไม่ได้ ไม่ร้อนจนสาร volatile ระเหยหมด" },
      { type: "tf", q: "Strappo (aspirate) คือการสูดอากาศเข้าปากตอนชิม", correct: true, explain: "Strappo เป็นเทคนิคเฉพาะ — ลองนึกว่าทำไมการสูดอากาศเข้าปากขณะชิมจึงช่วย retronasal aroma" },
      { type: "mc", q: "ทำไมต้องใช้แก้ว cobalt blue?", options: ["ทำให้สวย", "ซ่อนสี oil = ตัดสินได้ unbiased", "เก็บอุณหภูมิ", "ทุกข้อ"], correct: 1, explain: "สีน้ำเงินเข้มของแก้วทำหน้าที่กรองอะไร? ลองนึกว่าอะไรที่อาจ bias การตัดสิน EVOO ของผู้ชิม" },
      { type: "mc", q: "ระหว่างชิม ตัวต่อตัว ใช้อะไร cleanse ลิ้น?", options: ["กาแฟ", "นม", "แอปเปิ้ลเขียว / ขนมปังขาว", "ช็อกโกแลต"], correct: 2, explain: "ต้องใช้อาหาร neutral ที่ไม่มีรสชาติแรง และช่วย reset ลิ้นได้ระหว่างตัวอย่าง" },
      { type: "tf", q: "Tasting ควรทำหลังกินอาหารหนักทันที", correct: false, explain: "Protocol การชิมมีเงื่อนไขเตรียมตัวหลายอย่าง — ลองนึกว่าอาหารหนักก่อนชิมจะส่งผลต่อลิ้นและจมูกอย่างไร" },
      { type: "mc", q: "เวลาที่ลิ้น sensitive ที่สุดของวัน?", options: ["6:00-8:00", "10:00-12:00", "14:00-16:00", "20:00-22:00"], correct: 1, explain: "ลิ้น sensitive ที่สุดเมื่อยังไม่ถูกรบกวนจากอาหาร กาแฟ หรือสิ่งเร้าอื่น — ช่วงไหนที่เงื่อนไขครบ?" },
      { type: "tf", q: "Bitter 7/10 ใน EVOO คือ defect", correct: false, explain: "Bitter เป็น positive attribute หรือ defect? ลองนึกถึง 3 positive attributes ของ EVOO" },
    ],
  },
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    quiz: [
      { type: "mc", q: "Defect ที่พบบ่อยที่สุดใน EVOO?", options: ["Fusty", "Rancid", "Musty", "Metallic"], correct: 1, explain: "Defect นี้เกิดจาก oxidation ตามกาลเวลา — พบได้แม้ใน EVOO คุณภาพดีถ้าเก็บไม่ดีหรือนานเกินไป" },
      { type: "mc", q: "Rancid เกิดจากอะไร?", options: ["ผลหมัก", "Oxidation จากเวลา/แสง", "Mold", "ความร้อน"], correct: 1, explain: "Rancid = เหม็นหืน — เกิดจากปฏิกิริยาระหว่าง oil กับสิ่งที่อยู่ใน 4 ศัตรูของ EVOO" },
      { type: "mc", q: "ผลมะกอกกองไว้ 2 วันก่อนสกัด → defect ใด?", options: ["Rancid", "Fusty", "Cucumber", "Frostbitten"], correct: 1, explain: "การกองผลรวมกัน + oxygen + เวลา = fermentation เริ่ม — defect นี้มีชื่อ Italian ว่า 'morchia'" },
      { type: "mc", q: "ผลเก็บในที่ชื้น → defect ใด?", options: ["Musty", "Rancid", "Winey", "Hay"], correct: 0, explain: "ความชื้น + organic matter = เชื้อราและแบคทีเรีย — defect ชื่อนี้มาจากกลิ่นอับ ดิน น้ำขัง" },
      { type: "tf", q: "Pungent (เผ็ด) คือ defect", correct: false, explain: "Pungent อยู่ใน 3 positive attributes หรือ defect list? ลองนึกว่ามันบ่งบอกถึงสารอะไรใน EVOO" },
      { type: "mc", q: "Italian word ของ rancid?", options: ["Avvinato", "Muffa", "Rancido", "Riscaldo"], correct: 2, explain: "Italian term มักมาจากรากศัพท์ Latin ที่ใกล้เคียงคำ English — ลอง map คำ Italian ใน defect table" },
      { type: "mc", q: "Defect ที่เกิดจาก malaxation > 27°C?", options: ["Frostbitten", "Heated/Cooked", "Cucumber", "Metallic"], correct: 1, explain: "ถ้าอุณหภูมิ malaxation เกิน 27°C กระบวนการที่ควรเป็น 'cold' จะกลายเป็นอะไร? ชื่อ defect สื่อตรงๆ" },
      { type: "tf", q: "Cucumber defect เกิดจากผลที่ผสมกับแตงกวา", correct: false, explain: "Cucumber defect มีกลิ่นคล้ายแตงกวา แต่สาเหตุมาจากอะไร? ผลมะกอกเอง หรือบรรจุภัณฑ์?" },
      { type: "mc", q: "ฝึก rancid ที่บ้านยังไงเร็วสุด?", options: ["แช่ตู้เย็น", "วาง EVOO ใต้แสงแดด 3-4 สัปดาห์", "เติม vinegar", "ต้ม"], correct: 1, explain: "Rancid มาจาก oxidation — อะไรเร่ง oxidation ได้เร็วที่สุด? ลองนึกถึงศัตรูของ EVOO" },
      { type: "mc", q: "Defect ใดอยู่หมวด 'Fermentation defects'?", options: ["Rancid", "Hay", "Fusty / Winey / Musty", "Metallic"], correct: 2, explain: "Fermentation ต้องการ yeast/bacteria — defects ที่เกิดจากการหมักของผลมักมีมากกว่า 1 ชนิด" },
    ],
  },
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    quiz: [
      { type: "mc", q: "Physiological Sensory Suitability Cert ออกโดย?", options: ["EU", "IOC", "Italian Ministry of Agriculture", "FDA"], correct: 2, explain: "Cert นี้เกี่ยวกับ Italian panel system — ออกโดยหน่วยงานรัฐของ Italy ไม่ใช่ EU หรือ IOC" },
      { type: "mc", q: "การสอบประกอบด้วยกี่ส่วน?", options: ["1 ส่วน", "2 ส่วน", "3 ส่วน", "5 ส่วน"], correct: 2, explain: "สอบครอบคลุม threshold, discrimination, และ intensity — ลองนับ component ใน cert structure" },
      { type: "mc", q: "Detection threshold ของ rancid (IOC)?", options: ["~0.5", "~2.0", "~5.0", "~8.0"], correct: 1, explain: "IOC กำหนด threshold ไว้ — ตัวเลขนี้บ่งบอกระดับความเข้มต่ำสุดที่ต้องรับรู้ defect ได้" },
      { type: "tf", q: "Sommelier มืออาชีพต้อง detect defect ได้ที่ระดับต่ำกว่า threshold", correct: true, explain: "Sommelier มืออาชีพต้องมีความสามารถ detect ที่ระดับไหน เทียบกับ threshold ปกติ — ต่ำกว่าหรือสูงกว่า?" },
      { type: "mc", q: "Cert นี้ valid กี่ปี?", options: ["ตลอดชีวิต", "1 ปี", "2-3 ปี ต้อง re-cert", "10 ปี"], correct: 2, explain: "Sensory ability สามารถเปลี่ยนได้ตามเวลา ดังนั้น cert ต้อง renew — ดูระยะเวลาที่กำหนดใน lesson" },
      { type: "mc", q: "เวลาที่ดีที่สุดสำหรับ sensory practice?", options: ["หลังกินข้าวเช้า", "ก่อนกาแฟ ตื่นใหม่", "ก่อนนอน", "ระหว่างกินข้าว"], correct: 1, explain: "ประสาทสัมผัสดีที่สุดก่อนถูกรบกวน — เช็คจาก sensory protocol ว่าต้องเว้นสิ่งใดบ้าง" },
      { type: "tf", q: "Intensity modulation = ให้คะแนน defect ที่ความเข้มต่างกันสม่ำเสมอ", correct: true, explain: "Intensity modulation หมายถึงความสามารถ score defect ที่ระดับต่างกัน — ถ้าทำได้ดีต้องมีความสม่ำเสมออย่างไร?" },
      { type: "mc", q: "Mock panel ที่ดีควรทำกี่ครั้ง/สัปดาห์?", options: ["1 ครั้ง", "3 ครั้ง", "ทุกวัน", "เดือนละครั้ง"], correct: 0, explain: "ดูจาก training plan ใน lesson — ไม่ต้องทุกวัน แต่ต้องสม่ำเสมอ ลองนึกถึงจำนวนที่แนะนำ" },
    ],
  },
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    quiz: [
      { type: "mc", q: "Regulation EU ที่กำหนด EVOO grades?", options: ["432/2012", "2568/91", "1308/2013", "29/2012"], correct: 1, explain: "ดูจาก lesson EU regulations — แต่ละ regulation มีเลขที่และหน้าที่ต่างกัน กฎที่กำหนด grades ออกปี 1991" },
      { type: "mc", q: "EU approved claim ต้องมี polyphenols อย่างน้อย?", options: ["50 mg/kg", "100 mg/kg", "250 mg/kg", "500 mg/kg"], correct: 2, explain: "ดูจาก EU Regulation 432/2012 — polyphenol threshold ที่ต้องมีก่อนจะ claim health benefit ได้" },
      { type: "mc", q: "ตามกฎหมายไทย คำใดพูดได้?", options: ['"รักษาโรคหัวใจ"', '"Detox"', '"สารต้านอนุมูลอิสระ"', '"ลดน้ำหนัก"'], correct: 2, explain: "พ.ร.บ. อาหารไทยห้าม claim รักษาหรือป้องกันโรค — แต่อนุญาตให้พูดถึงสารในอาหารได้ตามจริง" },
      { type: "tf", q: "DOP ย่อมาจาก Denominazione di Origine Protetta", correct: true, explain: "DOP ย่อมาจาก 3 คำในภาษาอิตาลี — ลองดูว่า D, O, P แต่ละตัวย่อมาจากคำว่าอะไร" },
      { type: "mc", q: "Riviera Ligure DOP เป็นพื้นที่ของ?", options: ["Frantoio", "Picual", "Taggiasca (Galateo)", "Arbequina"], correct: 2, explain: "Riviera Ligure อยู่ใน Liguria — นึกถึงพันธุ์มะกอกที่เป็นตัวแทนของแถบนั้น ดู cultivar lesson" },
      { type: "tf", q: "Hibi ใช้ภาพ before/after ของลูกค้าได้", correct: false, explain: "ภาพ before/after เกี่ยวข้องกับกฎหมายอะไร? ลองนึกถึง marketing restrictions ใน lesson" },
      { type: "mc", q: "Framework การพูดที่ปลอดภัยมีกี่ Layer?", options: ["2", "3", "5", "7"], correct: 1, explain: "ดูจาก safe communication framework ใน lesson — มี Layer หลายชั้น ไม่ใช่ 2 ไม่ใช่ 5" },
      { type: "mc", q: "ห้ามทำอะไรกับคู่แข่งในไทย?", options: ["ดูสินค้าเขา", "ขายราคาถูกกว่า", "อ้างว่า 'ดีกว่า brand X' direct", "ทุกข้อ"], correct: 2, explain: "กฎหมายแข่งขันทางการค้าไทยมีข้อห้ามชัดเจน — ดูจาก marketing pitfalls ว่าห้ามทำอะไรกับ brand คู่แข่ง" },
    ],
  },
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    quiz: [
      { type: "mc", q: "Smoke point ของ EVOO?", options: ["100°C", "150°C", "190-210°C", "300°C"], correct: 2, explain: "EVOO มี smoke point สูงกว่าที่คนคิด เพราะ MUFA stable — สูงกว่า 150°C แต่ต่ำกว่า 300°C" },
      { type: "mc", q: "Power Glow ใช้ EVOO กี่ ml?", options: ["1ml", "3ml", "5ml", "10ml"], correct: 2, explain: "Power Glow เป็น signature Hibi drink — ดูจาก recipe ใน practical lesson" },
      { type: "tf", q: "EVOO ที่ดีต้องมีขวดใสเพื่อเห็นสี", correct: false, explain: "ขวดใสกับขวดสีเข้มต่างกันอย่างไรในการป้องกัน EVOO? ลองนึกถึงสิ่งที่ขวดใสไม่ป้องกัน" },
      { type: "mc", q: "Acidity ของ EVOO premium ควรเท่าไหร่?", options: ["≤ 0.3%", "≤ 1.0%", "≤ 2.0%", "≤ 3.0%"], correct: 0, explain: "Premium EVOO มีมาตรฐานสูงกว่า EVOO ทั่วไป — EVOO standard คือ ≤ 0.8% premium ต้องต่ำกว่านั้น" },
      { type: "mc", q: "Polyphenol level ของ premium EVOO?", options: ["≥ 100 mg/kg", "≥ 250 mg/kg", "≥ 500 mg/kg", "≥ 1000 mg/kg"], correct: 2, explain: "สูงกว่า EU health claim minimum (250 mg/kg) — ดูจาก buying guide ใน lesson" },
      { type: "mc", q: "การใช้ EVOO ที่ให้ value สูงสุด?", options: ["Deep fry", "Stir fry", "Drizzle finishing", "Salad dressing"], correct: 2, explain: "วิธีที่ preserve polyphenols และ aroma ได้ดีที่สุดคือหลีกเลี่ยงความร้อนสูง — ดู pairing rules" },
      { type: "tf", q: "EVOO ลึก deep frying ได้ทำให้คุ้มค่า", correct: false, explain: "Deep frying ใช้ EVOO ได้จากมุม smoke point — แต่ลองนึกว่าอะไรที่หายไปเมื่อ oil โดนความร้อนสูงนาน" },
      { type: "mc", q: "Harvest date ของ EVOO ควรไม่เกิน?", options: ["6 เดือน", "12 เดือน", "24 เดือน", "ไม่จำกัด"], correct: 1, explain: "EVOO ไม่เหมือนไวน์ ไม่ดีขึ้นตามอายุ — ดู best before recommendation ใน buying guide" },
    ],
  },
];
